document.write(` <footer class="footer bg_img pos-rel pt-20" data-background="assets/img/bg/footer-bg.jpg">
            ...
            <div class="row mt-none-30">
              <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                <div class="footer-widget mt-10">
                  <div class="xb-item--logo mb-30"><a href="#!"><img src="assets/img/logo/logo_white.svg" alt=""></a>
                  </div>
                  <span class="xb-item--details">Address: back side of samrat hotel Ananta Nagar Street, 1st Ln, Tata Benz Square, extension, Ram Nagar, Brahmapur, Odisha
                    <br>760005 </span>
              ...
              <div class="col-xl-2 col-lg-4 col-md-6 mt-30">
                <div class="footer-widget">
                  <ul class="xb-item--links-btn list-unstyled">
                    ...
                    <li><a class="thm-btn" href="#!">Notes</a></li>
